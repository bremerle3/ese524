...
subplot(2,2,1)
plot(0:length(lp11)-1,lp11,  0:length(lp12)-1,lp12,':',  0:length(lp21)-1, ...
    lp21,'-.',   0:length(lp22)-1,lp22,'--')
legend('EM trained, any path','EM trained, best path',...
    'VA trained, any path','VA trained, best path');
xlabel('iteration number')
ylabel('log likelihood')
input('position the legend')
print -dps ../pictures/hmmcmp.ps
print -deps ../pictures/hmmcmp.eps
