...
L = [h(4) 0    0    0    0    0      % first stage   % this one works
     h(2) h(3) h(4) 0    0    0
	 0    h(1) h(2) h(3) h(4) 0
	 0    0    0    h(1) h(2) h(3)
     0    0    0    0    0    h(1)];
...
%$$$ L1 = [h(4) 0    0    0     % this one works length(c1)=4
%$$$       h(2) h(3) h(4) 0   
%$$$       0    h(1) h(2) h(3)
%$$$       0    0    0    h(1)];
%$$$ 
...
%$$$ L1 = [h(4) 0    0    0    0      % this one works length(c1)=5
%$$$       h(2) h(3) h(4) 0    0
%$$$       0    h(1) h(2) h(3) h(4)
%$$$       0    0    0    h(1) h(2)];
%$$$ 
...
L1 = [h(3) h(4) 0    0    0       %  this one works, length(c1) = 5
      h(1) h(2) h(3) h(4) 0
      0    0    h(1) h(2) h(3)
	  0    0    0    0    h(1)];
